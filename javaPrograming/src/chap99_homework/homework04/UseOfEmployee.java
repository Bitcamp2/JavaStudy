...
public class UseOfEmployee {
	...
	public static void main(String[] args) {
		...
		// {new Employee(), newEmployee(), newEmployee(), ....}
		// {new RegularEmployee(), new TempEmployee(), new ContratEmployee(), ....}
		...
		while(true) {
			...
			public static Employee generateEmployee(Scanner sc, int menuSelcet) {
				...
				if(menuSelect == 1) {
					...
					return new RegularEmployee(eno, name, pay, menuSelct, bonus);
				...
				return new ContractEmployee(eno, name, play, menuSelect, workDay);
			}
