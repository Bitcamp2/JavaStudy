...
//	3. 매개변수: 메소드가 받아서 처리할 대상이 되는 값을 의미 한다.
//	매개변수의 지정 위치는 메스드 명 뒤 ()소괄호 안에 선언할 수 있다.
//	매개변수에 사용할 수 있는 타입은 기본자료형과 모든 참조타입
//	매개변수의 갯수는 제한이 없다. 개발자가 원하는대로 지정할 수 있다.
//	매개변수가 있는 메소드를 사용할 때는 항상 매개변수의 타입, 순서, 갯수를 맞춰야 한다.
	
//	메소드의 정의부(선언부): 메소드의 접근제어자, 리턴타입, 메소드명, 매개변수, 어떤 동작을 하는지를 지정함.
